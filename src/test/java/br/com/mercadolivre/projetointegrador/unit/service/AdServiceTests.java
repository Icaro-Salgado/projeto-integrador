...
public class AdServiceTests {
    ...
    @Test
    @DisplayName("Given valid values with three batches_ids, when call adService.createAd, then should call adRepository one time and adBatchesRespository three times.")
    ...
    @Test
    @DisplayName("Given a string as \"toddy\", when call listAds without and with these string, should call on repository findAll and findAdsByLikeName methods.")
    public void listAds() {
        adService.listAds();
    ...
    @Test
    @DisplayName("Given a seller id, when call listAdsByCustomerId, then should call on repository findAllBySellerId method.")
    ...
    @Test
    @DisplayName("Given a non-existing ad id, when call findAdById, then should throw an error containing \"Anúncio não localizado.\"")
    ...
    @Test
    @DisplayName("Given an existing ad id, when call deleteAd, then delete method from repository should be called once")
    ...
    @Test
    @DisplayName("Given a non-existing ad id, when call deleteAd, then should throw an error containing \"Não é permitido excluir o anúncio de outro usuário.\"")
    public void throwsWhenDeleteAnotherCustomerAd() {
        ...
        Assertions.assertEquals("Não é permitido excluir o anúncio de outro usuário.", thrown.getMessage());
    }
