...
public class ProductController {
  ...
  @Operation(summary = "CRIA UM NOVO PRODUTO", description = "Cria um novo produto através dos parametros:  name | category ")
  @ApiResponses(value = {
          @ApiResponse(
                  responseCode = "200",
  ...
  @Operation(summary = "ATUALIZA UM PRODUTO", description = "Atualiza um produto através de um ID válido")
  @ApiResponses(value = {
          @ApiResponse(
                  responseCode = "200",
                  description = "Produto atualizado com sucesso",
                  content = {@Content(mediaType = "application/json", schema = @Schema(implementation = CreateOrUpdateProductDTO.class))}),
          @ApiResponse(
                  responseCode = "400",
  ...
  @Operation(summary = "OBTEM UM PRODUTO PELO ID", description = "Obtem um produto informando um ID válido")
  @ApiResponses(value = {
          @ApiResponse(
                  responseCode = "200",
  ...
  @Operation(summary = "DELETA UM PRODUTO", description = "Deleta um produto através de um ID válido")
  @ApiResponses(value = {
          @ApiResponse(
                  responseCode = "404",
                  description = "Produto não encontrado",
