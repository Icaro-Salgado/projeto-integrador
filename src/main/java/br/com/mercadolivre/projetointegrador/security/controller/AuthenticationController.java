...
public class AuthenticationController {
  ...
  public ResponseEntity<?> registerWarehouseUser(@RequestBody @Valid RegisterDTO registerDTO) {
    AppUser created =
        authService.registerUser(AppUserMapper.INSTANCE.toModel(registerDTO), "MANAGER");
  ...
  public ResponseEntity<?> registerMarketplaceUser(@RequestBody @Valid RegisterDTO registerDTO) {
    AppUser created =
        authService.registerUser(AppUserMapper.INSTANCE.toModel(registerDTO), "CUSTOMER");
